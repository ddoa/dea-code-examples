...
class BolAnimatie extends JPanel implements Runnable { // Constants
	...
	private double ypos = (SIZE - BOLSIZE) / 2; // linksbovenhoek van bounding
												// vierkant!
	 ...
	 * positief. De variabelen xdir en ydir zijn -1 of 1 en bepalen de richting
	 * door vermenigvuldiging (bijvoorbeeld xdir*xspeed) Wanneer het balletje de
	 * rand van het speelveld dreigt te passeren, wordt de betreffende
	 ...
	 *
	 * @param ri
	 *            De gekozen hoek uit de regelaar
	 */
	...
	/**
	 * Snelheid instellen: hogere snelheid realiseren door de tijd bij sleep(int
	 * t) te verlagen. Dit wordt bereikt door 1000/snelheid als slaaptijd te
	 * nemen.
	 *
	 * @param s
	 *            De gekozen snelheid uit de regelaar
	 */
	 ...
	 */
	public void paintComponent(Graphics g) { // verplicht, zorgt voor witte
												// achtergrond
		super.paintComponent(g);
		// Bol bestaat uit in kleur verlopende concentrische cirkels (blauw ->
		// rood)
