...
class AnimatieRegelaar extends JPanel implements ActionListener { // Variables
	...
	public AnimatieRegelaar(BolAnimatie b, Color bg) {
		...
		add(richtingLabel);
		richtingInput = new JTextField(
				Integer.toString(BolAnimatie.STARTRICHTING), 5);
		...
		stapbutton.setLocation(130, 200);
		...
		add(snelheidLabel);
		snelheidInput = new JTextField(
				Integer.toString(BolAnimatie.STARTSNELHEID), 5);
	...
	public void actionPerformed(ActionEvent e) {
		...
		else if (e.getSource() == stapbutton) {
			ba.paintStep();
